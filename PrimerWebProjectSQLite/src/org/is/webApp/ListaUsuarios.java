...
public class ListaUsuarios {
	...
	// deploy path
	private String rutaArchivo = "PrimerWebProjectSQLite-0.1/datos/usuarios.db";
	
	// dev path (for eclipse)
	...
	*/
	...
	public ListaUsuarios () throws Exception{
		try{
			...
			// deployment path
			Connection conn = DriverManager.getConnection("jdbc:sqlite:PrimerWebProjectSQLite-0.1/datos/usuarios.db");
